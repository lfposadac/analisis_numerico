    ...
    def conversor(self,data):
        ...
        def to10Base(num, base, test="", comparate=""):
            ...
            Regreso:
                ...
                float (num [0] + "." + num [1])! = float (test): Comparamos si la parte después del punto
        ...
        def toBaseFirst(number, base):
            ...
            while True: #simulación para ciclo do-while
                ...
                if (total_aux // base ) < base:
                    ...
                    return total[::-1] # invertir el string
        ...
        def toBaseSecond(number, base, first, toBase):
            ...
            auxNumber = float("0." + str(number)) #parte del número después de la multiplicación en cada iteración
            totalFloat = auxNumber * base #número total después de la multiplicación en cada iteración
            ...
            for digit in total: 
                if digit != "0": # quitar los ceros a la izquierda
                    if index != 0:
